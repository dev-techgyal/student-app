	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<a href="{{ route('admin.home') }}" class="brand-link">
			<span class="brand-text font-weight-light"
			      style="margin-left: 30px;!important;">{{ env('APP_NAME') }}</span>
		</a>
		...
		<div class="sidebar">
			...
			<nav class="mt-2">
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
					...
					<li class="nav-item">
						<a href="{{ route('admin.add.sys.user') }}" class="nav-link">
					...
					<li class="nav-item">
						<a href="{{ route('admin.add.student') }}" class="nav-link">
							<i class="nav-icon fa fa-plus-square"></i>
							<p>
								Add Student
							</p>
					...
					<li class="nav-item">
						<a href="{{ route('admin.view.sys.user') }}" class="nav-link">
					...
					<li class="nav-item">
						<a href="{{ route('admin.view.student') }}" class="nav-link">
